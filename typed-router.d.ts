...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'charts-flow-line-charts-first-charts': RouteRecordInfo<'charts-flow-line-charts-first-charts', '/charts-flow/line-charts/first-charts', Record<never, never>, Record<never, never>>,
    'charts-flow-main-charts': RouteRecordInfo<'charts-flow-main-charts', '/charts-flow/main-charts', Record<never, never>, Record<never, never>>,
    'charts-flow-sankay-sankay-chart': RouteRecordInfo<'charts-flow-sankay-sankay-chart', '/charts-flow/sankay/sankay-chart', Record<never, never>, Record<never, never>>,
    'charts-flow-sankay-sankey-level': RouteRecordInfo<'charts-flow-sankay-sankey-level', '/charts-flow/sankay/Sankey-level', Record<never, never>, Record<never, never>>,
    'charts-flow-sun-burst-drink-flavor': RouteRecordInfo<'charts-flow-sun-burst-drink-flavor', '/charts-flow/sun-burst/drink-flavor', Record<never, never>, Record<never, never>>,
    'charts-flow-sun-burst-sunburst-round': RouteRecordInfo<'charts-flow-sun-burst-sunburst-round', '/charts-flow/sun-burst/sunburst-round', Record<never, never>, Record<never, never>>,
